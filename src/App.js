      ...
      >
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 24 }} test>
          ...
          >
            ...
            >
              <p>Guild Fighters is a medieval-based NFT collection I started in my apartment in Columbia, Maryland. It began as a personal hobby and evolved into a more serious enterprise. I put together the entire base and trait layers to generate these unique digital collectibles. I devised an algorithm that sums and averages the properties (Battle Club, Jade Sword, etc.) of each NFT a value based on the rarity level of each trait - this final value represents the product of the base price and the average rarity factor. As a quick aside, I also used the Yahoo Finance API to query real-time data on the current Ethereum price and used this dynamic (and volatile) value to calculate the price listings. Lastly, I created a method to ascribe certain statistics (speed, attack, etc.) to each fighter based on rarity affiliation. It took a while to tweak this in Python but I finally managed to produce the desired results.</p><br></br>
              <p>Check the roadmap and browse these items on OpenSea and Rarible! For OpenSea, the goal is to list 10,000 randomly generated NFTs for sale with Properties and Statistics metadata. On Rarible, the items are listed in an unlimited auction and are currently open for bids. Ping me on social media for any questions, advice, or future collaborations. Also, be sure to join the Discord community to share your thoughts, suggestions, and ideas!</p>
