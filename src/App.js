      ...
      >
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 24 }} test>
          ...
          >
            ...
            >
              <p>Guild Fighters is a fantasy-based NFT collection with a medieval theme. It began as a personal hobby and evolved into a more serious enterprise. I put together the base and trait layers, generated the unique digital collectibles, and continue to experiment with new ideas. I designed an algorithm that sums and averages the properties of each "listed" (for sale) NFT a given value based on the rarity level of each trait - this final value represents the product of the base price multiplied by the average rarity factor of the added properties. Lastly, I created a way to ascribe certain statistics (agility, power, etc.) to each fighter based on the rarity values of its properties. It took a while to tweak both methods but I managed to produce the desired results.</p><br></br>
              <p>You can check the product roadmap and browse these items on OpenSea and Rarible! For OpenSea, the goal is to produce 10,000 listed items for sale based on attribute rarity (weapon, guild, etc). On Rarible, the items are listed for sale in an unlimited auction and are open for bids. Feel free to ping me on social media for any questions, advice, or future collaborations.</p>
